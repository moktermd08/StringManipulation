 ...
 * Class String
 *
 * Provides functionalities for string  manipulation.
 *
 ...
 * 
 * @package GGlink\String
 */

namespace GGlink\String;
...
final class String implements \Countable {
	...
	/**
	 * Returns the part of this string *before* the *last* occurrence of the search string based on bytes
	 *
	 * This operation is case-sensitive
	 *
	 * The empty string (as a search string) is not considered to be a part of any other string
	...
	/**
	 * Returns the part of this string *before* the *last* occurrence of the search string based on code points
	 *
	 * This operation is case-sensitive
	 *
	 * The empty string (as a search string) is not considered to be a part of any other string
	...
	/**
	 * Alias of `beforeLastCodePoints`
	 *
	 * @param string $search
	 * @return static
	 */
	public function beforeLast($search) {
		return $this->beforeLastCodePoints($search);
	}
	...
	/**
	 * Returns the part of this string *after* the *first* occurrence of the search string based on bytes
	 *
	 * This operation is case-sensitive
	 *
	 * The empty string (as a search string) is not considered to be a part of any other string
	...
	/**
	 * Returns the part of this string *after* the *first* occurrence of the search string based on code points
	 *
	 * This operation is case-sensitive
	 *
	 * The empty string (as a search string) is not considered to be a part of any other string
	...
	/**
	 * Alias of `afterFirstCodePoints`
	 *
	 * @param string $search
	 * @return static
	 */
	public function afterFirst($search) {
		return $this->afterFirstCodePoints($search);
	}
